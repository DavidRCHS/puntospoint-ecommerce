...
RSpec.describe 'API', type: :request do
  let(:admin) do
    Admin.create!(email: 'admin@example.com', password_digest: Digest::SHA256.hexdigest('password'))
  end
  ...
  describe 'GET /api/v1/purchases' do
    it 'returns purchases based on provided filters' do
      get '/api/v1/purchases', { from: '2023-05-01', to: '2023-06-01' },
  ...
  describe 'GET /api/v1/purchases/count_by_granularity' do
    it 'returns the count of purchases based on granularity' do
      get '/api/v1/purchases/count_by_granularity',
        { granularity: 'day' }, { 'Authorization' => "Bearer #{token}" }
